...
namespace Chatter.Controllers
{
    public class ChatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ChatID,UserID,ChatMessage,ChatTimestamp")] Chat chat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ChatID,UserID,ChatMessage,ChatTimestamp")] Chat chat)
        {
            if (ModelState.IsValid)
            {
